...
1. Click on [Use this template](https://github.com/NethServer/ns8-webserver/generate).
...
Example:
    ...
    api-cli run module/webserver1/configure-module --data '{}'

The above command will:
- start and configure the webserver instance
- (describe configuration process)
- ...

Send a test HTTP request to the webserver backend service:

    curl http://127.0.0.1/webserver/
